...
$uname=$_SESSION['uname'];
    ...
    // echo $description;
     ...
     $query="insert into Product(UserName,ProductName,ProductID,CatagoryName,Price,Description,ProductStatus,Quantity,StartDate,EndDate,Buyer,Image)  values('$uname','$name','$ProID','$catagory','$price','$description','$ProductStatus','$Quantity','$sdate','$edate','Null','$destination')";
    ...
    <div class="row">
      ...
      <form action="" method="POST" enctype="multipart/form-data" role="form" name="BidForm">
            ...
            <div class="form-group">
              ...
              <input type="text" name="uname" maxlength="50" class="form-control" required>
            </div>
             <div class="form-group">
            ...
            <label class="control-label" for="ProductID">Product ID</label>
              <input type="number" name="ProductID" maxlength="50" class="form-control" required>
